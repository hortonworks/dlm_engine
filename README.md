...
-->
# Data Lifecycle Manager (DLM) Engine
...
Data Lifecycle Manager (DLM) is a DPS solution built on the Hortonworks DataPlane Service (DPS).

This repository is used for the DLM Engine, which is the agent that gets installed into your cluster and works with the DLM App.

Refer to [DLM App](https://github.com/hortonworks/dlm_app) for information on that repository.
