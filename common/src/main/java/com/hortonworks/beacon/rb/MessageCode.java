...
public enum MessageCode {
    ...
    ENTI_000018("NameNode HA isn't enabled in either {0} or {1} cluster"),
    ENTI_000019("Kerberos isn't enabled in either {0} or {1} cluster"),
    ENTI_000020("Ranger isn't enabled in either {0} or {1} cluster"),
    ENTI_000021("Hive isn't enabled in either {0} or {1} cluster"),
    ENTI_000022("Hive HA isn't enabled in either {0} or {1} cluster"),
    ENTI_000023("NameNode HA setup isn't correct"),
    ENTI_000024("Hive HA setup isn't correct"),
    ENTI_000025("Exception while accessing NameNode: {0}"),
    ENTI_000026("Kerberos setup isn't correct"),
    ENTI_000027("FS Endpoint provided {0} didn't match with cluster default FS endpoint {1}"),
