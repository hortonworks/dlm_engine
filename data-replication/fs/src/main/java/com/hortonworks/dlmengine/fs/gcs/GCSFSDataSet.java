...
package com.hortonworks.dlmengine.fs.gcs;
...
/**
 * GCS based implementation of HCFS data set.
 */
public class GCSFSDataSet extends HCFSDataset {
    private final ReplicationPolicy policy;

    public GCSFSDataSet(String path, BeaconCloudCred cloudCred, ReplicationPolicy policy) throws BeaconException {
    ...
    public boolean isEncrypted(Path path) {
        /* Encryption is by default enabled for GCS. */
        return true;
    }
