...
public abstract class FSListing<T> {
    ...
    public void updateListing(BeaconCluster cluster, String path) throws BeaconException {
    ...
    protected abstract T getListing(BeaconCluster cluster) throws BeaconException;
