...
public class BeaconFileStatus extends FileStatus implements Writable, Comparable {
    ...
    public BeaconFileStatus() { this(0, false, 0, 0, 0, 0, null, null, null, null); }

    //We should deprecate this soon?
    public BeaconFileStatus(long length, boolean isdir, int block_replication,
     ...
     */
    public BeaconFileStatus(long length, boolean isdir,
     ...
     */
    public BeaconFileStatus(FileStatus other) throws IOException {
   ...
   */
    ...
    public int compareTo(Object o) {
        BeaconFileStatus other = (BeaconFileStatus)o;
