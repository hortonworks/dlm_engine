...
*REST Call:* http://localhost:25000/api/beacon/policy/instance/list?filterBy=type:fs&numResults=1&sortOrder=DESC[http://localhost:25000/api/beacon/policy/instance/list/hdfspolicy?filterBy=type:fs&numResults=1&sortOrder=DESC]
...
*REST Call:* http://localhost:25000/api/beacon/policy/instance/list?filterBy=type:fs&numResults=1&sortOrder=DESC[http://localhost:25000/api/beacon/instance/list?filterBy=type:fs&numResults=1&sortOrder=DESC]
