...
hive.warehouse.dir=s3a://beacontest/hive/warehouse/
hive.exec.scratchdir=s3a://beacontest/tmp/hive/
...
*Note 4:* hive.metastore.uris, hive.warehouse.dir, hive.exec.scratchdir, hive.warehouse.subdir.inherit.perms and hive
...
Supported configuration for AWS:
...
*Description:* Update cloud credential entity configuration.
