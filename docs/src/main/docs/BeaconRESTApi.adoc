...
The target dataset path is provided with S3 bucket.
...
Supported configuration for S3:
...
name=cloud-cred
provider=S3
s3.access.key=AKIAJC
s3.secret.key=6LRK886v5YEmhkq
...
{
    "status": "SUCCEEDED",
    "message": "Credential [70ec301a-5be0-4e80-abb1-d1897f798b75] have R_W access to the path: [s3://dummy-bucket/].",
