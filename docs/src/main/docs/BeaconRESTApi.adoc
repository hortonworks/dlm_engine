...
*Note 1:* dfs.namenode.kerberos.principal is custom property

*Note 2:* dfs.nameservices, dfs.internal.nameservices, dfs.ha.namenodes.<nameservice>, dfs.namenode.rpc-address.<nameservice>.<namenode1>,
