...
[source, properties]
hive.metastore.warehouse.dir=<cloud storage path like wasb://wasb-hive@dummy-wasb-account.blob.core.windows.net/apps/hive/warehouse or s3a://dummy-s3-bucket/apps/hive/warehouse>
hive.repl.replica.functions.root.dir=<cloud storage path like wasb://wasb-hive@dummy-wasb-account.blob.core.windows.net/apps/hive/repl or s3a://dummy-s3-bucket/apps/hive/repl>
