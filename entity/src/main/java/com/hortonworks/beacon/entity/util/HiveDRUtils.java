...
public final class HiveDRUtils {
    ...
    public static String getConfigParameters(Properties properties, Configuration fsConf) throws BeaconException {
        ...
        /** Set max memory for map task process */
        appendConfig(builder, JobConf.MAPRED_MAP_TASK_JAVA_OPTS, "-Xmx640m");
