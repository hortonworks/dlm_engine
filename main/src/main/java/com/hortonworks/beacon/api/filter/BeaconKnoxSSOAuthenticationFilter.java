...
public class BeaconKnoxSSOAuthenticationFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        LOG.info("Beacon KNOXSSO AuthenticationFilter doFilter-1:");
                ...
                if (serializedJWT != null) {
                    ...
                    try {
                        ...
                        if (valid) {
                            ...
                            LOG.info("Knox SSO user: [{}]", userName);
    ...
    public static RSAPublicKey parseRSAPublicKey(String pem)
        ...
        try {
            ...
            LOG.info("CertificateException : {} ", ce);
            String message = null;
            ...
            LOG.info("CertificateException : {} ", uee);
