...
/**
 * Policy Instance Killed Event class.
 */
public class PolicyInstanceDeletedEvent extends BeaconEvent {
    private static final String EVENT_MESSAGE = "policy instance deleted";
    private String policyId;
    private String instanceId;
    private String eventMessage;

    public PolicyInstanceDeletedEvent(Events event, PolicyInstanceBean bean) {
        super(event);
