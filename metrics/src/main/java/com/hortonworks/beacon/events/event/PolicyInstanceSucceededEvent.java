...
/**
 * Policy Instance Succeeded Event class.
 */
public class PolicyInstanceSucceededEvent extends BeaconEvent {
    private static final String EVENT_MESSAGE = "policy instance succeeded";
    private String policyId;
    private String instanceId;
    private String eventMessage;

    public PolicyInstanceSucceededEvent(Events event, PolicyInstanceBean bean) {
        super(event);
