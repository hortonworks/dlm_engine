...
/**
 * Policy Resumed Event class.
 */
public class PolicyResumedEvent extends BeaconEvent {
    private static final String EVENT_MESSAGE = "replication policy resumed";
    private String policyId;
    private String eventMessage;
    private EventInfo eventInfo;

    public PolicyResumedEvent(Events event, PolicyBean bean, EventInfo eventInfo) {
        super(event);
