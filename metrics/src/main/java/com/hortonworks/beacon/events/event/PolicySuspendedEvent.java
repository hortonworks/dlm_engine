...
/**
 * Policy Suspended Event class.
 */
public class PolicySuspendedEvent extends BeaconEvent {

    private static final String EVENT_MESSAGE = "replication policy suspended";
    private String policyId;
    private String eventMessage;
    private EventInfo eventInfo;

    public PolicySuspendedEvent(Events event, PolicyBean bean, EventInfo eventInfo) {
        super(event);
