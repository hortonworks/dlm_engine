...
public final class FileSystemUtils {
    protected static final Logger LOG = LoggerFactory.getLogger(FileSystemUtils.class);
    ...
    public static InputStream getInputStream(FileSystem fs, Path filePath) throws IOException {
        try {
