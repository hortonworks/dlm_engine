...
public class ImportRequestProviderTest extends RequestProviderBase {
    ...
    public void anyRequest() {
        String expectedTransforms = String.format(ImportProcess.ImportRequestProvider.IMPORT_TRANSFORM_FORMAT,
                SOURCE_CLUSTER_NAME,
                TARGET_CLUSTER_NAME);

        AtlasImportRequest request = ImportProcess.ImportRequestProvider.create(
                SOURCE_CLUSTER_NAME,
                TARGET_CLUSTER_NAME);
